///файл, отвечающий за уровень в игре
#ifndef LEVEL_H
#define LEVEL_H
...
//главный класс - уровень
class Level {
private:
	int width, height, tileWidth, tileHeight;			//переменные, которые будет хранить даные из tmx-файла об уровне
	...
	std::vector<Layer> layers;			//массив классов
public:
...
int Object::GetPropertyInt(std::string name)			//возвращаем номер свойства в списке
{
...
std::string Object::GetPropertyString(std::string name)			//получаем имя в виде строки
{
